...
const HomesInfo:NextPage=()=>{
    return(
        ...
        <div style={{display:'flex',justifyContent:'space-around',marginTop:'30px'}}>
            ...
            <div>
            <Link  href={'/'}><button style={{width:'200px',height:'70px',border:'4px solid blue',borderRadius:'10px',backgroundColor:'blue',fontSize:'20px',color:'white',marginTop:'30px'}}>Back →</button></Link>
            </div>
